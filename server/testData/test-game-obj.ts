  ...
  chapters: [
    {
      ...
      chapterEvent: {
        ...
        units:
          "UNIT Zael Shaman Zael Level(4, Enemy, True) [16, 4] 0x00 0x00 0x0 0x00 [Flux, Nosferatu, Vulnerary] GuardTileAI\nUNIT Elden Myrmidon 0x00 Level(3, Ally, True) [5, 2] 0x00 0x00 0x0 0x00 [IronSword, Vulnerary] NoAI\nUNIT Nythoria Mage_F 0x00 Level(4, Ally, True) [1, 0] 0x00 0x00 0x0 0x00 [Fire, Vulnerary, Elfire] NoAI\nUNIT Mira Cleric 0x00 Level(2, NPC, True) [1, 0] 0x00 0x00 0x0 0x00 [Heal, Vulnerary] AttackInRangeAI\nUNIT Soldier Knight 0x00 Level(2, Enemy, True) [14, 5] 0x00 0x00 0x0 0x00 [IronLance, Vulnerary] ChaseOnceApproachedAI\nUNIT Soldier Mage 0x00 Level(2, Enemy, True) [15, 5] 0x00 0x00 0x0 0x00 [Fire, Vulnerary] ChaseOnceApproachedAI\nUNIT Soldier Soldier 0x00 Level(1, Enemy, True) [16, 6] 0x00 0x00 0x0 0x00 [IronLance, Vulnerary] ChaseOnceApproachedAI\nUNIT Soldier Mage 0x00 Level(2, Enemy, True) [17, 6] 0x00 0x00 0x0 0x00 [Fire, Vulnerary] ChaseOnceApproachedAI",
        beginningScene:
        ...
        localDefinitions: [
          ...
          "ArmoryList:\nSHLI IronSword IronLance IronAxe IronBow Javelin SteelAxe Dasher LightBrand SteelAxe\nALIGN 4",
