  ...
  chapters: [
    {
      ...
      chapterEvent: {
        ...
        units:
          "UNIT Lyra Cavalier_F 0x00 Level(19, Ally, True) [1, 1] 0x00 0x00 0x0 0x00 [SteelSword, IronLance, Vulnerary, AngelicRobe] NoAI\nUNIT Zalrix Shaman 0x00 Level(1, Ally, True) [2, 1] 0x00 0x00 0x0 0x00 [Flux, Nosferatu, Vulnerary] NoAI\nUNIT Garrick Mercenary Garrick Level(1, Enemy, True) [3, 1] 0x00 0x00 0x0 0x00 [IronSword, Vulnerary, Speedwing] GuardTileAI",
        beginningScene:
          "LOAD1 0x1 Units\nMUSC Legends_of_Avenir\nText(Forest,the_gathering_storm_PreBattleScene)\nFadeOutMusic",
        endingScene:
