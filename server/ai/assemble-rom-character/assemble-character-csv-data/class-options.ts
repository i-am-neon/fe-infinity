...
export const classOptionsMaleOnly: ClassOption[] = [
  ...
  // { name: "Journeyman", description: "An untrained fighter with limited combat abilities, uses axes." },
  {
    name: "Pirate",
    description: "An axe-wielding fighter who can move over water terrain.",
  },
  // { name: "Pupil", description: "A trainee magic user with low stats but potential for growth in magic." }
];
...
export const classOptionsFemaleOnly: ClassOption[] = [
  ...
  // { name: "Recruit", description: "A trainee soldier with potential for growth, starting with limited combat abilities." }
];
