  ...
  // },
  {
    ...
    areas: [
      ...
      },
      {
        ...
        subAreas: [
          ...
          },
          {
            name: "Road",
            description:
              "A pathway that connects different areas, facilitating movement.",
            coordinates: {
              from: {
                x: 6,
                y: 5,
      ...
      },
      {
        name: "Western Wing",
        description:
          "A section of the map with walls and a door, leading to other areas.",
        subAreas: [
          {
            name: "Wall Corridor",
            description:
          ...
          },
          {
            name: "Doorway",
            description:
              "An entrance leading to the next area, marked by a door.",
            coordinates: {
              from: {
                x: 18,
                y: 12,
