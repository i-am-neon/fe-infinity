...
export const allMapOptions: MapData[] = [
  {
    ...
    description:
      "A desert-themed map featuring various terrains including cliffs, forests, and lakes, with several points of interest such as forts and houses.",
    ...
    areas: [
      {
        ...
        description:
          "A vast expanse of desert terrain with cliffs to the east and a few scattered points of interest.",
        subAreas: [
          {
            name: "Cliffside",
            description:
              "The area along the cliffs with limited access, providing strategic high ground.",
            coordinates: {
              from: {
                x: 8,
                y: 0,
          ...
          },
          {
            name: "Desert Plains",
            description:
              "Open desert area with few obstacles, allowing for movement and exploration.",
            coordinates: {
              from: {
                x: 0,
                y: 0,
      ...
      },
      {
        name: "Central Forts",
        description:
          "A central area dominated by forts and roads, serving as a strategic point for battles.",
        subAreas: [
          {
            name: "Fort Area",
            description:
              "Contains multiple forts that can be captured or defended.",
            coordinates: {
              from: {
                x: 10,
                y: 1,
          ...
          },
          {
            ...
            description:
              "Connecting roads that facilitate movement between different areas.",
            coordinates: {
              from: {
                x: 7,
                y: 8,
      ...
      },
      {
        ...
        description:
          "A village area with houses and a vendor, providing resources and shelter.",
        subAreas: [
          {
            name: "Village Entrance",
            description:
              "The main entry point to the village, marked by walls and a house.",
            coordinates: {
              from: {
                x: 1,
                y: 18,
          ...
          },
          {
            name: "Vendor Area",
            description:
              "A small area where players can purchase items and supplies.",
            coordinates: {
              from: {
                x: 6,
                y: 11,
